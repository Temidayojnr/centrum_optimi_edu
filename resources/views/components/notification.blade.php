...
<div x-data="{ show: true }" 
    ...
    @if(session('warning'))
    <div class="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded-lg shadow-lg">
        <div class="flex items-start">
            <div class="flex-shrink-0">
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-lg shadow-lg">
        <div class="flex items-start">
            ...
            <div class="ml-auto pl-3">
                <button @click="show = false" class="inline-flex text-blue-400 hover:text-blue-600 focus:outline-none">
                    <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                    </svg>
                </button>
