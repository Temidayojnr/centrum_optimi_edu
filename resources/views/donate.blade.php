...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="section-subtitle">See how your donation makes a difference</p>
        </div>
        
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="card p-8 text-center">
                <div class="text-4xl font-bold text-gold-600 mb-2">₦5,000</div>
                <p class="text-gray-600">Provides learning materials for 5 students</p>
            </div>
            <div class="card p-8 text-center">
                <div class="text-4xl font-bold text-gold-600 mb-2">₦20,000</div>
                <p class="text-gray-600">Sponsors one student for a term</p>
            </div>
            <div class="card p-8 text-center">
                <div class="text-4xl font-bold text-gold-600 mb-2">₦100,000</div>
                <p class="text-gray-600">Establishes a mobile learning center</p>
            </div>
        </div>
    </div>
</section>
